...
const createCycle = async (request) => {
  return Vue.prototype.$http.post(`http://localhost:5000/api/cycle/create`, request);
}

const updateCycle = async (request) => {
  return Vue.prototype.$http.post(`http://localhost:5000/api/cycle/update`, request);
}
