...
const getData = async (pageIndex, pageSize, description) => {
    ...
    return Vue.prototype.$http.post(`http://172.20.10.25:5000/api/reply/getAll`, query);
}
...
const updateReply = async (request) => {
  return Vue.prototype.$http.post(`http://172.20.10.25:5000/api/reply/update`, request);
}
