...
const getData = async (pageIndex, pageSize, description) => {
    ...
    return Vue.prototype.$http.post(`http://dev-twedu.southeastasia.cloudapp.azure.com:5018/api/reply/getAll`, query);
}
...
const updateReply = async (request) => {
  return Vue.prototype.$http.post(`http://dev-twedu.southeastasia.cloudapp.azure.com:5018/api/reply/update`, request);
}
