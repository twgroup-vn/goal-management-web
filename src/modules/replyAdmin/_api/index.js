...
const getData = async (pageIndex, pageSize, description) => {
    ...
    return Vue.prototype.$http.post(`https://dev-kpi-api.twgroup.vn/api/reply/getAll`, query);
}
...
const updateReply = async (request) => {
  return Vue.prototype.$http.post(`https://dev-kpi-api.twgroup.vn/api/reply/update`, request);
}
