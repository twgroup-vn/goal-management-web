...
const SET_RELATED_DATA = (state, messages) => {
    state.userList = messages.userList;
    state.departmentList = messages.departmentList;
    state.positionList = messages.positionList;
}
