...
const getGoalListOfUser = async (pageIndex, pageSize, description, title) => {
    ...
    return Vue.prototype.$http.post(`http://localhost:5000/api/goal/getGoalOfUser`, query);
}
...
const createGoal = async (request) => {
    return Vue.prototype.$http.post(`http://localhost:5000/api/goal/create`, request);
}
  
const updateGoal = async (request) => {
    return Vue.prototype.$http.post(`http://localhost:5000/api/goal/update`, request);
}

const createCheckIn = async (request) => {
    return Vue.prototype.$http.post(`http://localhost:5000/api/checkIn/create`, request);
  }
  
const updateCheckIn = async (request) => {
    return Vue.prototype.$http.post(`http://localhost:5000/api/checkIn/update`, request);
}
